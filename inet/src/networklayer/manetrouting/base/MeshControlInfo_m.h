...
class INET_API MeshControlInfo : public ::Ieee802Ctrl
{
  protected:
    ...
    ManetAddress *vectorAddress_var; // array ptr
  ...
  public:
    ...
    virtual ManetAddress& getVectorAddress(unsigned int k);
    virtual const ManetAddress& getVectorAddress(unsigned int k) const {return const_cast<MeshControlInfo*>(this)->getVectorAddress(k);}
    virtual void setVectorAddress(unsigned int k, const ManetAddress& vectorAddress);
};
