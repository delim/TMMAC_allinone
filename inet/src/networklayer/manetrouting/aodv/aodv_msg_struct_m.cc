//
// Generated file, do not edit! Created by opp_msgc 4.3 from networklayer/manetrouting/aodv/aodv_msg_struct.msg.
//
...
int RREPDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='e' && strcmp(fieldName, "extension")==0) return base+12;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}
...
int RREPDescriptor::getArraySize(void *object, int field) const
{
    ...
    switch (field) {
        case 12: return pp->getExtensionArraySize();
        default: return 0;
    }
}
...
std::string RREPDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 12: {std::stringstream out; out << pp->getExtension(i); return out.str();}
        default: return "";
    }
}
...
void *RREPDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 12: return (void *)(&pp->getExtension(i)); break;
        default: return NULL;
    }
}
